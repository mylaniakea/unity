...
import { HardDrive, Cpu, RefreshCw, Network, Zap, BookPlus, Clock, Database } from 'lucide-react';
...
interface HardwareData {
    ...
    gpu?: { Vendor?: string; Device?: string; Model?: string; Class?: string, Type?: string }[];
    timestamp?: string;
}
