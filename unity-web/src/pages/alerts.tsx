...
import { Bell, CheckCircle, AlertTriangle, Settings, Mail, MessageCircle, Smartphone, Hash, Server, Link } from 'lucide-react';
...
export default function Alerts() {
    ...
    useEffect(() => {
        ...
        if (!updatesPaused) {
            interval = setInterval(fetchAlerts, 120000);
        }
        ...
        try {
            if (editingChannel.id) {
                await api.put(`/alerts/channels/${editingChannel.id}`, {
                    ...
                    template: editingChannel.template,
                });
        ...
        <div className="space-y-8 h-[calc(100vh-140px)] flex flex-col">
            ...
            <div className="flex border-b border-border shrink-0">
                <button
                    ...
                    className={`px-4 py-2 font-medium transition-colors ${activeTab === 'alerts' ? 'border-b-2 border-primary text-primary' : 'text-muted-foreground hover:text-foreground'
                        }`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium transition-colors ${activeTab === 'channels' ? 'border-b-2 border-primary text-primary' : 'text-muted-foreground hover:text-foreground'
                        }`}
                >
                                            ...
                                            {configuredChannel && (
                                                <>
                                                    <button
                                                        ...
                                                        className={`px-3 py-2 rounded-md text-sm ${configuredChannel.enabled
