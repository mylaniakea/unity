...
export default function Profiles() {
    ...
    // We might need to adjust how we handle sidebar closing. 
    // In unity-web Layout, sidebar is persistent on desktop. 
    // The original code tried to close sidebar to maximize terminal space.
    // For now, we'll ignore sidebar closing on desktop or just let it overlay.
