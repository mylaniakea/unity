...
import { Brain, Search, Server, X, Hash, Trash2 } from 'lucide-react';
...
export default function Knowledge() {
    // const [items, setItems] = useState<KnowledgeItem[]>([]); // items is unused
                ...
                {selectedItem && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <div className="p-4 border-t border-border bg-muted/20 flex gap-2 overflow-x-auto">
                                {selectedItem.tags.map(tag => (
                                    <span key={tag} className="text-xs flex items-center gap-1 bg-background border border-border px-2 py-1 rounded whitespace-nowrap">
                                        <Hash size={10} /> {tag}
                                    </span>
                                ))}
                            </div>
