...
import { Bot, Send, Sparkles, Server, Save, Activity } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 h-[calc(100vh-140px)] flex flex-col">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 min-h-0">
                {/* Chat Area */}
                <div className="md:col-span-2 bg-card border border-border rounded-xl flex flex-col overflow-hidden shadow-sm">
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        ...
                        {loading && <div className="text-sm text-muted-foreground animate-pulse ml-2">Thinking...</div>}
                    </div>
