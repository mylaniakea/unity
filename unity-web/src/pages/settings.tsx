        ...
        <div className="space-y-6">
            ...
            <div className="flex space-x-1 mb-6 bg-card/50 p-1 rounded-xl backdrop-blur-sm">
                <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-md transition-colors ${activeTab === 'ai'
                ...
                <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-md transition-colors ${activeTab === 'password'
                        ? 'bg-primary text-primary-foreground shadow-sm'
                        : 'text-muted-foreground hover:text-foreground hover:bg-accent'
                        }`}
                >
                ...
                <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-md transition-colors ${activeTab === 'automations'
                        ? 'bg-primary text-primary-foreground shadow-sm'
                        : 'text-muted-foreground hover:text-foreground hover:bg-accent'
                        }`}
                >
